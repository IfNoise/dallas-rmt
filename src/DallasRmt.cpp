...
bool DallasRmt::readScratchPad(const uint8_t *deviceAddress,
                               uint8_t *scratchPad) {
...
void DallasRmt::writeScratchPad(const uint8_t *deviceAddress,
...
bool DallasRmt::setResolution(const uint8_t *deviceAddress,
...
int16_t DallasRmt::calculateTemperature(const uint8_t *deviceAddress,
                                        uint8_t *scratchPad) {
